                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            inputStyle.email_SUP_TextField(size),
                            SizedBox(
                              height: size.height * 0.02,
                            ),
                            inputStyle.phoneTextField(size),
                            SizedBox(
                              height: size.height * 0.02,
                            ),
                            inputStyle.passwordTextFieldSignUP(size),
                            SizedBox(
                              height: size.height * 0.03,
                            ),
                            inputStyle.confermpasswordTextField(size),
