...
import 'package:razza_app/Screens/signup-in/Phone/siginup_Phone.dart';
import 'package:razza_app/Screens/signup-in/Phone/signin_Phone.dart';

class InputStyle {
  TextEditingController emailController = TextEditingController();
  TextEditingController phoneNumber = TextEditingController();
  TextEditingController userPassSignUP = TextEditingController();

//***************************************************** */

//************SIGN IN CONTROLLER********************** */

  Widget emailTextField_signin(Size size) {
    return Container(
  ...
  Widget phoneoption_signin(Size size, context) {
    return Container(
...
//************SIGN UP CONTROLLER********************** */
      ...
      child: SizedBox(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: phoneNumber.text.isEmpty
                ? const Color.fromRGBO(248, 247, 251, 1)
                : Colors.transparent,
            enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(40),
                borderSide: BorderSide(
                  color: phoneNumber.text.isEmpty
                      ? Colors.transparent
                      : const Color.fromRGBO(44, 185, 176, 1),
                )),
            focusedBorder: OutlineInputBorder(
      ...
      child: SizedBox(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor: userPassSignUP.text.isEmpty
                ? const Color.fromRGBO(248, 247, 251, 1)
                : Colors.transparent,
            enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(40),
                borderSide: BorderSide(
                  color: userPassSignUP.text.isEmpty
                      ? Colors.transparent
                      : const Color.fromRGBO(44, 185, 176, 1),
                )),
            focusedBorder: OutlineInputBorder(
            ...
            suffix: Container(
              ...
              child: userPassSignUP.text.isEmpty
                  ? const Center()
                  : const Icon(
                      Icons.check,
                      color: Colors.white,
  ...
  Widget signUpPhoneNumber(Size size, context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Icon(
