                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                FadeInLeft(
                                  child: inputStyle.emailTextField(size),
                                  delay: Duration(milliseconds: 1200),
                                ),
                                SizedBox(height: 15),
                                FadeInLeft(
                                  child: inputStyle.passwordTextField(size),
                                  delay: Duration(milliseconds: 1500),
                                ),
                                FadeInLeft(
                                  child: inputStyle.phoneoption(size),
                          ...
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                ...
                                FadeIn(
                                  child: inputStyle.buildContinueText(),
                          ...
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 30),
                                FadeIn(
                                    child: inputStyle.buildFooter(size),
                                    delay: Duration(milliseconds: 2600)),
                              ],
                            ),
                          ),
